...
%   Copyright 2022-2024 The MathWorks, Inc.
    ...
    methods
        ...
        function s = getChannelStatistics(obj,varargin)
            ...
            % provided. This is required for EMLSR when the pathgains are
            % generated for the maximum possible number of antennas.
            if sigStructPresent
                txAntIdx = 1:sig.NumTransmitAntennas;
                rxAntIdx = 1:rxInfo.NumReceiveAntennas;
                pathGainsUse = pathGainsUse(:,:,txAntIdx,rxAntIdx);
            end
