function [psdu,cfgRx,res] = recoverNonHT(rxPacket,chanEst,noiseVarEst,chanBW,mcs,length,cfgDataRec,demodLLTF)
%recoverNonHT Recover data bits from Non-HT Data field
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   [PSDU,CFGRX,RES] = recoverNonHT(RX,CHANEST,NOISEEST,CHANBW,MCS,LENGTH,CFGDATAREC,DEMODLLTF)
...
[psdu,eqSymCombined,cpe,peg,pilotgain,scramInit,eqSym] = wirelessWaveformAnalyzer.internal.trackingNonHTDataRecover( ...
    rxData,chanEst,noiseVarEst,cfgRx,cfgDataRec,demodLLTF);
