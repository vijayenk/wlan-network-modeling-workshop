function y = dsssData(PSDU,cfgDSSS)
%dsssData DSSS processing of the PSDU
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   Y = dsssData(PSDU,CFGDSSS) generates a DSSS modulated PSDU
...
%
%      waveformPSDU = dsssData(bitsPSDU,cfgDSSS);
%
%   See also wlanNonHTConfig, dsssPreamble, dsssHeader.
