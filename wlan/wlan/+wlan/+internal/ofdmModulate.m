function y = ofdmModulate(x,cplen,varargin)
%ofdmModulate Perform OFDM modulation
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   Y = ofdmModulate(X, CPLEN) performs OFDM modulation on the
...
%
%   Y = ofdmModulate(X, CPLEN, OSF) performs OFDM modulation given an
