...
% Validate inputs
validateattributes(x,{'double','single'},{'2d','finite'},mfilename,'HT-Data field input');
validateattributes(chanEst,{'double','single'},{'3d','finite'},mfilename,'Channel estimate input');
...
[cfgOFDM,~,pilotInd] = wlan.internal.getOFDMConfig(cfgHT.ChannelBandwidth,cfgHT.GuardInterval,'HT',numSTS);
