function [y,CRC] = dsssHeader(cfgDSSS)
%dsssHeader DSSS PLCP Header
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   [Y, CRC] = dsssHeader(CFGDSSS) generates a DSSS modulated Physical
...
%
%      header = dsssHeader(cfgDSSS);
%
%   See also wlanNonHTConfig, dsssPreamble, dsssData.

%   Copyright 2015-2025 The MathWorks, Inc.

%#codegen

% Only applicable for DSSS modulation of the non-HT format configuration
...
scrambled = wlan.internal.dsssScramble([preambleBits; headerBits], ...
...
if (strcmpi(cfgDSSS.Preamble,'Long'))
    ...
    % DBPSK modulation
    symbols = wlan.internal.dsssPSKModulate(scrambled,'1Mbps');
else
    ...
    scrambled = [reshape(repmat(scrambled(1:P,1),1,2).',P*2,1); ...
        scrambled(P+1:end,1)];
    % DQPSK modulation
    symbols = wlan.internal.dsssPSKModulate(scrambled,'2Mbps');
end
...
% Barker spreading
y = wlan.internal.dsssBarkerSpread(symbols);
