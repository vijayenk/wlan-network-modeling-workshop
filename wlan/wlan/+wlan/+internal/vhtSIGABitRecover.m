function [bits, failCRC] = vhtSIGABitRecover(sym, noiseVarEst, csi)
%vhtSIGABitRecover Recover information bits in VHT-SIG-A field
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   [BITS, FAILCRC] = vhtSIGABitRecover(SYM, NOISEVAREST, CSI)
...
demodOut = wlanConstellationDemap(sym.*[1 -1i], noiseVarEst, 1); % [48, 2]

% Apply CSI and concatenate OFDM symbols in the first dimension
demodOut = reshape(demodOut .* repmat(csi, 1, 2), 48*2, 1); % [48*2, 1]
