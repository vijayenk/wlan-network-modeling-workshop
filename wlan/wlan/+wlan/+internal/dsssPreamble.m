function y = dsssPreamble(cfgDSSS)
%dsssPreamble DSSS PLCP Preamble
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
%
%   Y = dsssPreamble(CFGDSSS) generates a DSSS modulated PLCP Preamble
...
%
%      preamble = dsssPreamble(cfgDSSS);
%
%   See also wlanNonHTConfig, dsssHeader, dsssData.
...
scrambled = wlan.internal.dsssScramble(preambleBits, ...
