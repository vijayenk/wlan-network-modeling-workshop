...
%   specified in IEEE Std 802.11-2016, Section 19.3.11.10. PILOTS is sized
...
%
%   CHANBW is the channel bandwidth character vector. NSTS is the total
%   number of space time streams (1:4) N is the index of the OFDM symbol
%   (0:...)
...
switch chanBW
    case {'CBW2','CBW20'}
        % Per row for one mode of NSTS and iSTS - IEEE Std 802.11-2016,
        % Table 19-19 Each row holds the pilots for all subcarriers per
        % symbol
        pBasePilotMatrix = [ ...
        ...
        pPilotMod = 4; % IEEE Std 802.11-2016, Equation 19-54
    otherwise % case {'CBW4','CBW40'}
        ...
        pPilotMod = 6; % IEEE Std 802.11-2016, Equation 19-55
end
iSTS = (1:NSTS).'; % Indices of space-time streams 

stIdxVec = [1 2 4 7]; % Row offset for each NSTS
idx = (mod(nC(:,1)+(0:pPilotMod-1),pPilotMod)+1).';
