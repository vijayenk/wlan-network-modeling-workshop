function occupied = heRUSegmentOccupied(cbw,ruSize,ruIndex)
%heRUSegmentOccupied 20 MHz segment index containing the specified RU
%
%   Note: This is an internal undocumented function and its API and/or
%   functionality may change in subsequent releases.
% 
%   OCCUPIED = heRUSegmentOccupied(CBW,RUSIZE,RUINDEX) returns a
...
%   242, 484, or 996. It can be a scalar or array.
%
...
% Get the start and end index for each 20 MHz segment in the HE portion
N20MHz = cbw/20;
Nfft = 256;
...
for i = 1:numRUs
    ...
    k = wlan.internal.heRUSubcarrierIndices(cbw,ruSize(i),ruIndex(i));
