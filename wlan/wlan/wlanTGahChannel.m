...
%   NumTransmitAntennas property value of tgah. Y is the output signal of
%   size Ns-by-Nr, where Nr is the number of receive antennas, which takes
%   the same value as the NumReceiveAntennas property value of tgah. Y
...
%   PathGainsOutputPort property of tgah is set to true. PATHGAINS is of
...
%
%   PATHGAINS = step(tgah) produces path gains PATHGAINS where the duration
...
%   info     - Return characteristic information about the TGah channel 
%
...
properties (Access = public)
    ...
    %   property is 80.
    NumSamples (1,1) {mustBeNumericOrLogical, mustBeInteger, mustBePositive, mustBeReal} = 80;
end
