function est = wlanPreHEChannelEstimate(demodSym,chEstLLTF,cbw,varargin)
%wlanPreHEChannelEstimate Pre-HE channel estimate
%
%   wlanPreHEChannelEstimate(DEMODSYM,CHESTLLTF,'CBW320') is not
%   recommended. Use wlanPreEHTChannelEstimate(DEMODSYM,CHESTLLTF,'CBW320')
%   instead.
%
%   EST = wlanPreHEChannelEstimate(DEMODSYM,CHESTLLTF,CBW) returns the full
...
%   or 'CBW320'.
%
%   EST = wlanPreHEChannelEstimate(...,SPAN) performs frequency smoothing
